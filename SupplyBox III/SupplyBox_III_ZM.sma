...
new boxstil,roundmode,soundmode,enfectmode
...
public plugin_init()
{
	...
	boxstil = register_cvar("supplybox_mod","2") // 1- Normal silahlar // 2- Extra itemler // 3- Karisik
	...
	enfectmode = register_cvar("supplybox_enfeksiyonzamani_at","0") // Sureyi Enfeksiyon Zamani Baslatir.
