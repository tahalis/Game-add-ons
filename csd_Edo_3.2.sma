...
public bomb_planted(id)round_setc4[id]=1
...
public TYendi( )
{
	...
	if(edopuani){
		...
		formatex(goruntulenecekmesaj,1070,"%s^nElin En Degerli Oyuncusu^n^nRound Icinde Oldurus                  [%d]",kazananismi[0],edopuani)
